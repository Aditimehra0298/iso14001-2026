          ...
          <div className="site-footer-col site-footer-col--contact">
            ...
            <dl className="site-footer-contact">
              ...
              <div className="site-footer-contact-row">
                ...
                <dd>
                  <ul className="site-footer-offices">
                    {SITE_OFFICES.map((office) => (
                      <li key={office.country} className="site-footer-office">
                        <span className="site-footer-office-country">{office.country}</span>
                        {office.phone && office.tel ? (
                          <a href={`tel:${office.tel}`} className="site-footer-office-phone">
                            <Phone className="site-footer-office-phone-icon" strokeWidth={2} />
